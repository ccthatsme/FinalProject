...
public class missedIngredients {
	...
	public missedIngredients() {
		super();
		// TODO Auto-generated constructor stub
	}

	public missedIngredients(Integer id, Integer amount, String unit, String unitShort, String aisle, String name,
	...
	public String toString() {
		return "missedIngredients [id=" + id + ", amount=" + amount + ", unit=" + unit + ", unitShort=" + unitShort
