...
<body>
	...
	Subtract how much ${food.name } to your pantry?
	<br> Current Amount: ${food.quantity } ${food.quantityUnit }
	<form action="subtract-amt">
		<input type="hidden" value="${food.id }" name="food"> <input
			type="number" placeholder="1.0" step="0.01" min="0" name="qty">
		<input list="unitChoice" name="unitChoice">
